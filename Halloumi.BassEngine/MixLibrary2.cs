...
namespace Halloumi.BassEngine
{
    ...
    public class MixLibrary2
    {
        ...
        public MixLibrary2(Library library, string mixDetailsFolder)
        {
            _library = library;
        ...
        private class MixTracks
        {
            ...
            public void Save(string filename)
            {
                ...
                if (content.Length == 0 && File.Exists(filename))
                {
        ...
        private class MixTrack
        {
            ...
            public static MixTrack FromString(string value)
            {
                ...
                if (value.Contains(","))
                {
                    mixTrack.TrackDescription = value.Split(',')[0].Trim();
                    mixTrack.MixLevel = Convert.ToInt32(value.Split(',')[1].Trim());
                }
                else
                {
